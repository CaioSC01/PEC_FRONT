...
import { ModalGroup } from '../components/Modals/ModalAdd/ModalAddGroup'
// import Form from './Form'
import './page.style/classific.css'
import { useState } from 'react'

export const GroupCli = () => {
                ...
                >
                  ...
                  >
                    ...
                    <Modal.Footer>
                      <button
                        type="button"
                        className="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-[#9a8e74] hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                        onClick={handleClose}
                      >
                        Cancelar
                      </button>
